...
tools: Agent(scout, analyst, architect, developer, reviewer-correctness, reviewer-security, reviewer-maintainability, tester, refiner), Read, Write, Edit, Grep, Glob, Bash(git log *), Bash(git diff *), Bash(git status *), Bash(git commit *), Bash(git branch *), Bash(git rev-parse *), Bash(git show *), Bash(git shortlog *), Bash(gh *), Bash(ls *), Bash(wc *)
model: inherit
color: lavender
skills:
  - setup
