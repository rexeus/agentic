...
- **Changes ready to ship?** `/agentic:verify` — pre-ship quality gate. Runs the reviewer trio and the tester trio in parallel — six lenses plus full test execution. Broader than review.
...
| tester-coverage          | "What is not yet tested?"        | Prove      |
